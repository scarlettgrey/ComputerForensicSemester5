...
def openDirHDDrecov():
    DirHDDRecov = filedialog.askdirectory()
    EntryTargetDiskHDDRecov.insert(0,DirHDDRecov)
...
EntryTargetDiskHDDRecov = tk.Entry(tabHDD)
EntryTargetDiskHDDRecov.grid(row=0,column=1,columnspan=2,ipadx=165,pady=5,sticky="E")
tk.Button(tabHDD,text="...",command=openDirHDDrecov).grid(row=0,column=2,ipadx=5,pady=5,sticky="E")
...
def openDirFormat():
    DirFormat = filedialog.askdirectory()
    EntryTargetDiskFormat.insert(0,DirFormat)
...
EntryTargetDiskFormat = tk.Entry(tabFormat)
EntryTargetDiskFormat.grid(row=0,column=1,columnspan=2,ipadx=140,pady=5,sticky="E")
tk.Button(tabFormat,text="...",command=openDirFormat).grid(row=0,column=2,ipadx=5,pady=5,sticky="E")
