...
LabelTargetDiskFormat.grid(row=0,column=0,pady=5,padx=5)
EntryTargetDiskFormat = ttk.Combobox(tabFormat,values=OccupiedDrivesLetter)
EntryTargetDiskFormat.grid(row=0,column=1,columnspan=2,ipadx=25,sticky="E",padx=5)
tk.Checkbutton(tabFormat,text="Generate Report").grid(row=1,column=0,padx=5)
tk.Button(tabFormat,text="Start Format").grid(row=1,column=2,sticky="E",padx=5)
...
tk.Checkbutton(tabEnc,text="Generate Report").grid(row=2,column=0,pady=5,padx=5)
tk.Button(tabEnc,text="Encrypt").grid(row=2,column=2,pady=5,sticky="E",padx=5)
...
tk.Checkbutton(tabDec,text="Generate Report").grid(row=2,column=0,pady=5,padx=5)
tk.Button(tabDec,text="Decrypt").grid(row=2,column=2,pady=5,sticky="E",padx=5)
